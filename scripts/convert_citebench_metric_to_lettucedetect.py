"""Convert CiteBench metric_eval JSON to LettuceDetect inference input format.
...
def _build_row(row: dict[str, Any], include_flat_context: bool) -> dict[str, Any]:
    ...
    response = _safe_text(row.get("prediction"))
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Convert CiteBench metric_eval JSON to LettuceDetect input format")
